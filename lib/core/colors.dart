...
class AppColors {
  ...
  static const Color yellowButton = Color(0xFFFDF6CF);
  static const Color secondary = Color(0xFFFBFBFB);
  static const Color grey = Color(0xFFDADEE3);
  static const Color textBlack = Color(0xFF09101D);
  static const Color textBlackLight = Color(0xFF686F6F);
  static const Color textLightGrey = Color(0xFFACACAC);
  static const Color textGrey = Color(0xFF545D69);
  static const Color greyText = Color(0xFF858C94);
  static const Color greyTextLight = Color(0xFF6D7580);
  static const Color white = Color(0xFFffffff);
  static const Color textLightYellow = Color(0xFFFDF6CF);
  static const Color yellowSoft = Color(0xFFF3EFE3);
  static const Color blueSoft = Color(0xFFdfecf6);
  static const Color grayBottomNav = Color(0xFFF4F6F9);
  ...
  static const Color yellow = Color(0xFFE3AC14);
  static const Color yellowName = Color(0xFFC38E0E);
  static const Color goldText = Color(0xFFC38E0E);
  static const Color yellowLights = Color(0xFFFDF6CF);
  static const Color gray = Color(0xFFb5baba);
  static const Color grays = Color(0xFF858C94);
  static const Color green = Color(0xFF4ED350);
