...
class AppStyle {
  ...
  static TextStyle styleTextBody24({Color? colorText, double? size = 24, FontWeight? fontWeight, TextDecoration? decoration}) => TextStyle(
        color: colorText ?? AppColors.textBlack,
        fontWeight: fontWeight,
        fontSize: size,
        decoration: decoration,
  ...
  static InputDecoration inputDecorationFloating(String hint, {Widget? suffixIcon, Widget? prefixIcon, bool? disableLabel}) => InputDecoration(
        hintText: hint,
  ...
  static InputDecoration inputDecorationFloatingTreatment(String hint, {Widget? suffixIcon, bool? disableLabel}) => InputDecoration(
        ...
        suffixIcon: suffixIcon,
        floatingLabelStyle: AppStyle.styleTextBody18(colorText: AppColors.primary, fontWeight: FontWeight.bold),
        hintStyle: AppStyle.styleTextBody14(
